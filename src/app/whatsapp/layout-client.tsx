...
const NAV_ITEMS = [
  { href: "/whatsapp", label: "Dashboard", icon: LayoutDashboard, exact: true },
  { href: "/whatsapp/conversations", label: "Conversations", icon: MessageSquare },
  { href: "/whatsapp/contacts", label: "Contacts", icon: Users },
  { href: "/whatsapp/campaigns", label: "Campaigns", icon: Megaphone },
...
interface WhatsAppLayoutClientProps {
  children: React.ReactNode;
}

export function WhatsAppLayoutClient({ children }: WhatsAppLayoutClientProps) {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-4 border-b border-stone-200 dark:border-stone-700 flex items-center justify-between">
        <Link href="/whatsapp" className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-stone-400 dark:text-stone-500">Marketing</p>
          </div>
        </Link>
        <button
      ...
      <div className="px-3 py-3 border-b border-stone-200 dark:border-stone-700">
        ...
        >
          ...
          <ChevronDown
            size={14}
            className={`text-stone-400 transition-transform ${brandDropdownOpen ? "rotate-180" : ""}`}
          />
        </button>
